...
<section class="sx-consent" id="sx-analytics-consent" role="dialog" aria-labelledby="sx-consent-title" aria-describedby="sx-consent-description" hidden>
	<h2 id="sx-consent-title">Mesure d’audience</h2>
	<p id="sx-consent-description">Avec ton accord, Microsoft Clarity nous aide à comprendre l’utilisation du site grâce à des statistiques et des enregistrements de navigation. Tu peux accepter, refuser ou changer d’avis à tout moment.</p>
	<p><a href="<?php echo esc_url( $privacy_url ); ?>">Consulter la politique de confidentialité</a></p>
	<div class="sx-consent__actions">
		<button type="button" class="sx-consent__accept" data-weas-consent="granted">Accepter les statistiques</button>
		<button type="button" class="sx-consent__deny" data-weas-consent="denied">Refuser</button>
	</div>
</section>
<button type="button" class="sx-consent-manage" data-weas-consent-manage hidden>Gérer mes cookies</button>
...
(function(window, document) {
	...
	public static function filter_privacy_content( string $content ): string {
		...
		$disclosure = '<section id="weas-microsoft-clarity"><h2>Microsoft Clarity — mesure d’audience</h2>'
			...
			. '<p>Tu peux retirer ton consentement à tout moment avec le bouton « Gérer mes cookies ». Le retrait empêche les futurs chargements de Clarity et supprime les cookies Clarity accessibles depuis WEAS.</p>'
			...
			. '<button type="button" class="sx-consent-manage sx-consent-manage--inline" data-weas-consent-manage>Gérer mes cookies</button></section>';
